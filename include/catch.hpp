...
#  endif
    ...
    // This is just here to avoid compiler warnings with macro constants and bool literals
...
namespace Catch
{
    ...
    void
    registerTestCaseFunction(TestFunction function, SourceLineInfo const &lineInfo, NameAndDesc const &nameAndDesc);
...
namespace Clara {
    ...
    const unsigned int consoleWidth = 80;
        ...
        inline void convertInto( std::string const& _source, bool& _dest ) {
            ...
            if( sourceLC == "y" || sourceLC == "1" || sourceLC == "true" || sourceLC == "yes" || sourceLC == "on" )
                ...
                throw std::runtime_error( "Expected a bool value but did not recognise:\n  '" + _source + "'" );
        }
    ...
    class CommandLine {
        ...
        public:
            ...
            // Bind a non-bool data member (requires placeholder string)
            template<typename C, typename M>
            void bind( M C::* field, std::string const& placeholder ) {
                m_arg->boundField = new Detail::BoundDataMember<C,M>( field );
                m_arg->placeholder = placeholder;
            }
            // Bind a bool data member (no placeholder required)
            template<typename C>
            void bind( bool C::* field ) {
                m_arg->boundField = new Detail::BoundDataMember<C,bool>( field );
            }

            // Bind a method taking a single, non-bool argument (requires a placeholder string)
            template<typename C, typename M>
            ...
            // Bind a method taking a single, bool argument (no placeholder string required)
            template<typename C>
